  ...
  return (
    ...
    >
      <div className="flex-1 mx-auto max-w-7xl px-6 py-10 md:py-16">
        {/* back to centered vertical alignment */}
        <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-8 md:gap-12">
          {/* VIDEO: original position, just bigger on desktop */}
          <div className="order-2 md:order-1 mb-8 md:mb-0">
            <div className="w-full rounded-xl overflow-hidden bg-transparent">
              <video
                className="block w-full h-auto md:max-h-[650px] object-contain bg-transparent"
          ...
          <div className="order-1 md:order-2 text-center md:text-left mx-auto md:mx-0">
            ...
            <div className="display-font leading-[0.9] mb-6">
              <h1 className="text-[#4B2C1A] font-black text-6xl md:text-8xl">PROTEIN</h1>
              <h2 className="text-[#2F7A43] font-black text-6xl md:text-8xl">BUBBLE TEA</h2>
            </div>
