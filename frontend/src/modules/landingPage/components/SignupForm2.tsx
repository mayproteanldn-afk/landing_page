// frontend/src/modules/landingPage/components/SignupForm.tsx
...
export default function SignupForm({
    ...
    const handleSubscribe = async () => {
        ...
        try {
            const res = await fetch(`${API_BASE}/api/subscribe`, {
                ...
                body: JSON.stringify({ firstName, email, signupSource }),
            });
    ...
    return (
        <div>
            {headline ? (
                <p className="italic text-lg md:text-[17px] xl:text-xl mb-6">{headline}</p>
            ) : null}
